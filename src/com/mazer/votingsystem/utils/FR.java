...
{
	static int result;
   public FR() throws Exception, Exception {
	    int i;
	    result =123;
             ...
             genGraph( 
                    getCN(
                        getFastParallelAlgoSkeleton(
                            binarizing(
                                ImageIO.read(FR.class.getResource("sample1.png"))))));
                ...
                compare(graph1, 
                    genGraph( 
                        getCN(
                            getFastParallelAlgoSkeleton(
                                binarizing(
                                    ImageIO.read(FR.class.getResource("sample"+i+".png")))))) )
        );
//        result = compare(graph1, genGraph( 
//                        getCN(
//                            getFastParallelAlgoSkeleton(
//                                binarizing(
//                                    ImageIO.read(FR.class.getResource("sample"+i+".png")))))) );
